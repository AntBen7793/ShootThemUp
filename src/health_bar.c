...
void draw_health_bar(int x, int y, int width, int height, Player *player, MLV_Image *hud, MLV_Image *shield_icon,MLV_Image *bomb_icon, MLV_Font *font_hud, MLV_Image *filtre)
{
    ...
    MLV_draw_image(bomb_icon, x + 90, y + 25);
    char text_bomb[10];
    snprintf(text_bomb, sizeof(text_bomb), "%d", player->shot);
    MLV_draw_text_with_font(x + 130, y + 20, text_bomb, font_hud, MLV_COLOR_RED);
